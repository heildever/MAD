...
public class dynamic_example extends AppCompatActivity implements GoogleApiClient.OnConnectionFailedListener {

    private static final String TAG = "dynamic_example";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.dynamic_example);
                        ...
                        new ResultCallback<AppInviteInvitationResult>() {
                            ...
                            public void onResult(@NonNull AppInviteInvitationResult result) {
                                if (result.getStatus().isSuccess()) {
                                    ...
                                    //((TextView) findViewById(R.id.link_view_receive)).setText(data.getQueryParameter("apn").toString());
                                    Log.d(TAG, "data: *************************");
                                    Log.d(TAG, "apn: " + data.toString());
                                    Log.d(TAG, "group" + data.getQueryParameter("group").toString());
                                    // ((TextView) findViewById(R.id.link_view_receive)).setText(data.getQueryParameter("group"));
                                    // [END_EXCLUDE]
                                } else {
        ...
        ((TextView) findViewById(R.id.link_view_receive)).setText(appLinkData.toString() + " " + appLinkAction.toString());
    ...
    public Uri buildDeepLink(@NonNull Uri deepLink, int minVersion, boolean isAd) {
        ...
        Uri.Builder builder = new Uri.Builder()
                ...
                //.appendQueryParameter("group", "aca va la lista de grupos");
